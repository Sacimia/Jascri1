function media(){
    ...
    if(med >= 6 ){ //se a média for 6 ou mais
        msg ='Passou de bimestre'
    }else{
        msg = 'Estude'
    }
    ...
    res.innerHTML += `<p>A mensagem que temos é: <strong style='color:red;'>${msg}</strong></p>` // Nota que eu usei até um pouco de CSS pra fazer a mensagem ficar vermelha
}